...
void controls()
{
    ...
    letter1(0,0,0,"4 - DOWN");
    glPopMatrix();

    glPushMatrix();
    glTranslatef(-0.85,0.2,0);
    letter1(0,0,0,"2 - LEFT");
     glPopMatrix();

    glPushMatrix();
    glTranslatef(-0.85,0.1,0);
    letter1(0,0,0,"1 - RIGHT");
     glPopMatrix();

   glPushMatrix();
    glTranslatef(-0.85,0,0);
    letter1(0,0,0,"6 - INSIDE");
     glPopMatrix();

   glPushMatrix();
    glTranslatef(-0.85,-0.1,0);
    letter1(0,0,0,"5 - OUTSIDE");
     glPopMatrix();
...
void intro()
{
    ...
    setfont1(GLUT_BITMAP_HELVETICA_18);
    letter1(0,0,0,"TOPIC:3D House simulator");
    glPopMatrix();
    ...
    letter1(0,0,0,"TEJAS. N. S");
     glPopMatrix();

          glPushMatrix();
    glTranslatef(-0.85-0.13,-0.03,0);
    letter1(0,0,0,"USN:4SO16CS114");
     glPopMatrix();
    ...
    glPopMatrix();
      ...
      glPushMatrix();
    glTranslatef(0.3-0.65,0.03,0);
    letter1(0,0,0,"ROSWIN H FERNANDES");
     glPopMatrix();

   glPushMatrix();
    glTranslatef(0.3-0.65,-0.03,0);
    letter1(0,0,0,"USN:4SO16CS094");
     glPopMatrix();

     glPushMatrix();
    glTranslatef(0.3-0.65,-0.1,0);
    letter1(0,0,0,"VI SEM CSE");
    glPopMatrix();

    glPushMatrix();
    glTranslatef(0.3+0.23,0.03,0);
    letter1(0,0,0,"SHAMEEK M");
     glPopMatrix();

   glPushMatrix();
    glTranslatef(0.3+0.23,-0.03,0);
    letter1(0,0,0,"USN:4SO16CS101");
     glPopMatrix();

     glPushMatrix();
    glTranslatef(0.3+0.23,-0.1,0);
    letter1(0,0,0,"VI SEM CSE");
    glPopMatrix();
    ...
    letter1(0,0,0,"BEGIN YOUR JOURNEY BY CLICKING HERE");
    glPopMatrix();
